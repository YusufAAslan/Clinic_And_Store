		...
		<div class="panel-group category-products" id="accordian"><!--category-products-->
			...
			<?php if(isset($categories) && is_array($categories)):?>
		 	...
		 	<?php endif; ?>
		                 ...
		                 <h2><?php echo $lang['Advanced-search'] ?></h2>
                      	 <!--searchbox-->
                      	 <style>
                      	 	.my-table{
                      	 ...
                      	 <form method="get">
                      	 		<table class="my-table table table-condensed">
                       	 				<tr>
                       	 					...
                       	 					<td>
                       	 						<input value="<?php Search::get_sticky('textbox','description')?>" autofocus="true" type="text" class="form-control" name="description" placeholder="<?php echo $lang['Type_product_name'] ?>">
                       	 					</td>
                       	 			 	...
                       	 			 	<tr>
                       	 					<td>
                       	 						<select class="form-control" name="category">
                       	 							<option><?php echo $lang['Select_category'] ?></option>
                       	 				...
                       	 				<tr>
                       	 					<td>
                       	 					<div><?php echo $lang['price_range']?></div>
                       	 				...
                       	 				<tr>
                        	 				<td>
                       	 						<select class="form-control" name="year">
                       	 							<option><?php echo $lang['Select_year']?></option>
                       	 							 <?php Search::get_years('year')?>

                       	 						</select>
                       	 					</td>
                       	 				</tr>
 										<tr><td ><input type="submit" name="search" value="<?php echo $lang['search']?>" class="btn btn-success pull-right"></td></tr>
                      	 		</table>
                      	 </form>
